...
| Pattern              | Usage                           | Example                                                                                                                           |
| -------------------- | ------------------------------- | --------------------------------------------------------------------------------------------------------------------------------- |
| dou suru ba + clause | Asking for advice on what to do | A：どうするばいいですか。(Dou suru ba ii desu ka.)<br>B：もっと勉強したほうがいいですよ。(Motto benkyou shita hou ga ii desu yo.) |
| dou shita + clause   | Asking for advice on what to do | A：どうしたらいいですか。(Dou shitara ii desu ka.)<br>B：もっと勉強したほうがいいですよ。(Motto benkyou shita hou ga ii desu yo.) |
...
| V-te + Verb (e.g., 見てみる)      | Try doing something      | A：この映画を見てみるのはどうですか。(Kono eiga wo mite miru no wa dou desu ka.)<br>B：いいですね、見てみましょう。(Ii desu ne, mite mimashou.) |
...
| V-て + くれます (te kuremasu)                | Someone does (verb) for you (informal)      | A：友達が手伝ってくれました。(Tomodachi ga tetsudatte kuremashita.)<br>B：優しい友達ですね。(Yasashii tomodachi desu ne.)                            |
