...
| Pattern                                                                              | Usage                       | Example                                                                                                                                                                                  |
| ------------------------------------------------------------------------------------ | --------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 何と読みますか (nan to yomimasu ka)                                                  | Ask how to read a word      | A：この漢字は何と読みますか。(Kono kanji wa nan to yomimasu ka.)<br>B：「やま」と読みます。("Yama" to yomimasu.)                                                                         |
| 何と書きますか (nan to kakimasu ka)                                                  | Ask how to write a word     | A：「やま」は何と書きますか。("Yama" wa nani to kakimasu ka.)<br>B：「山」と書きます。("Yama" to kakimasu.)                                                                              |
| ～と書いてあります (to kaite arimasu)                                                | Indicates written form      | A：「山」と書いてあります。("Yama" to kaite arimasu.)<br>B：そうですね、山です。(Sou desu ne, yama desu.)                                                                                |
