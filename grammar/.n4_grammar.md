...
| Group     | Pattern                            | Formation               | Example                                                                   |
| --------- | ---------------------------------- | ----------------------- | ------------------------------------------------------------------------- |
| Group I   | V［い］ます → V［え］な            | Change い to え, add な | 読みます → 読むな (yomimasu → yomu na)                                    |
| Group II  | V ます → V るな                    | Remove ます, add るな   | 食べます → 食べるな (tabemasu → taberu na)                                |
| Group III | きます → くるな<br>します → するな | Irregular forms         | 来ます → 来るな (kimasu → kuru na)<br>します → するな (shimasu → suru na) |
...
| Pattern                                                                              | Usage                       | Example                                                                                                                                                                                  |
| ------------------------------------------------------------------------------------ | --------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 何と読みますか (nani to yomimasu ka)                                                 | Ask how to read a word      | A：この漢字は何と読みますか。(Kono kanji wa nani to yomimasu ka.)<br>B：「やま」と読みます。("Yama" to yomimasu.)                                                                        |
| 何と書きますか (nani to kakimasu ka)                                                 | Ask how to write a word     | A：「やま」は何と書きますか。("Yama" wa nani to kakimasu ka.)<br>B：「山」と書きます。("Yama" to kakimasu.)                                                                              |
